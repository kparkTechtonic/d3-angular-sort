...
export class BarchartComponent implements OnInit, OnChanges {
  ...
  createChart() {
    ...
    // bar colors
    this.colors = d3.scaleLinear().domain([0, this.data.length]).range(<any[]>['yellow', 'purple']);
  ...
  updateChart() {
    ...
    this.chart.selectAll('.bar').transition()
      ...
      .style('fill', (d, i) => {
        // console.log(d);
        // console.log(i)
        // console.log(Number(d[0].split("Index ")[1]));
        return this.colors(Number(d[0].split("Index ")[1]));
